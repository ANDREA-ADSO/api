...
using WebAppApiyey.Model;
using WebAppApiyey.Services;

namespace WebAppApiyey.Services
{
    public class EmpleadoService : IEmpleadoService
    {
        private readonly List<Empleado> _empleadosList; public EmpleadoService()
        {
...
{
Id = 1,
Identificacion = "12345", Nombre = "Juan Rubio", HorasTrabajadas = 10,
SueldoPorHora = 100, IsActive = true
}
};
        }
        ...
        public Empleado AddEmpleado(AddUpdateEmpleado obj)
        {
            ...
            {
                Id = _empleadosList.Any() ? _empleadosList.Max(emp
                => emp.Id) + 1 : 1,
            ...
            _empleadosList.Add(newEmpleado); return newEmpleado;
        }
        public bool DeleteEmpleadoByID(int id)
        {
            ...
            if (empleadoIndex >= 0)
            {
                _empleadosList.RemoveAt(empleadoIndex); return true;
            }
            return false;
        }
